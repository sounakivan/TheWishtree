...
FirstPersonMovement.prototype.update = function(dt) {
    ...
    if (this.app.xr.active) {
        ...
        inputSources.forEach(function(inputSource) {
                ...
                // if(inputSource.gamepad.axes[2] < 0) {
                //     angle += 1;
                // } 
                // else if(inputSource.gamepad.axes[2] > 0) {
                //     angle -= 1;
                // } 
                if(inputSource.gamepad.buttons[0].value) {
                    x += forward.x;
                    z += forward.z;
                }
        });
        ...
        // this.camera.setLocalEulerAngles(this.entity.getLocalEulerAngles());
    }
